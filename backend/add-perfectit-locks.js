...
async function addPerfectITLocks() {
  try {
    ...
    const projectCityId = address.city.projectCities[0]?.id
    ...
    const newLocks = [
      {
        ...
        secretKey: 'PERFECTIT_MAIN_001_SECRET_KEY',
      ...
      },
      {
        ...
        isOnline: true,
        isActive: true,
        deviceId: 'PERFECTIT-SERVER-002',
        secretKey: 'PERFECTIT_SERVER_002_SECRET_KEY',
        addressId: address.id,
        projectCityId: projectCityId
      },
      {
        ...
        isOnline: true,
        isActive: true,
        deviceId: 'PERFECTIT-CONF-003',
        secretKey: 'PERFECTIT_CONF_003_SECRET_KEY',
        addressId: address.id,
        projectCityId: projectCityId
      }
    ]
